...
try {
    ...
    $stmt = $koneksi->prepare("SELECT p.222247_id_pesanan, u.222247_nama_lengkap, p.222247_tanggal_pesanan, p.222247_status_pesanan, p.222247_total_harga, p.222247_jumlah
