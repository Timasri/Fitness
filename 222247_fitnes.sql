...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2026 at 07:04 PM
...
--
-- Table structure for table `tbl_info_222247`
--
...
--
-- Table structure for table `tbl_pegawai_222247`
--
...
--
-- Dumping data for table `tbl_pegawai_222247`
--
...
(1, 'timasri12', '12345678', 'Timasri Olympia', 'Admin', '081341039855', '8bf66c389cf60d3aaa81da7cc542050a');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pembayaran_222247`
--
...
--
-- Table structure for table `tbl_pengguna_222247`
--
...
--
-- Dumping data for table `tbl_pengguna_222247`
--
...
(1, 'timasri user', '12345678', 'timasri fernandez', 'timasriundipa@gmail.com', '081341039855', 'perintis kemerdekaan 7', '1171b74594793a5a38ca9ebdec2ac5a0');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pesanan_222247`
--
...
--
-- Table structure for table `tbl_produk_222247`
--
...
--
-- Dumping data for table `tbl_produk_222247`
--
...
--
-- Indexes for table `tbl_info_222247`
--
...
--
-- Indexes for table `tbl_pegawai_222247`
--
...
--
-- Indexes for table `tbl_pembayaran_222247`
--
...
--
-- Indexes for table `tbl_pengguna_222247`
--
...
--
-- Indexes for table `tbl_pesanan_222247`
--
...
--
-- Indexes for table `tbl_produk_222247`
--
ALTER TABLE `tbl_produk_222247`
  ADD PRIMARY KEY (`222247_id_produk`);

--
-- Indexes for table `tbl_ulasan_222247`
--
...
--
-- AUTO_INCREMENT for table `tbl_info_222247`
--
ALTER TABLE `tbl_info_222247`
  MODIFY `222247_id_info` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `tbl_pegawai_222247`
--
ALTER TABLE `tbl_pegawai_222247`
  MODIFY `222247_id_pegawai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_pembayaran_222247`
--
ALTER TABLE `tbl_pembayaran_222247`
  MODIFY `222247_id_pembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `tbl_pengguna_222247`
--
ALTER TABLE `tbl_pengguna_222247`
  MODIFY `222247_id_pengguna` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbl_pesanan_222247`
--
ALTER TABLE `tbl_pesanan_222247`
  MODIFY `222247_id_pesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `tbl_produk_222247`
--
ALTER TABLE `tbl_produk_222247`
  MODIFY `222247_id_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `tbl_ulasan_222247`
--
ALTER TABLE `tbl_ulasan_222247`
...
--
-- Constraints for table `tbl_info_222247`
--
ALTER TABLE `tbl_info_222247`
...
--
-- Constraints for table `tbl_ulasan_222247`
--
ALTER TABLE `tbl_ulasan_222247`
